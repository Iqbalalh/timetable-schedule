...
-- CreateIndex
CREATE UNIQUE INDEX "academicPeriods_periodName_key" ON "academicPeriods"("periodName");
...
-- CreateIndex
CREATE UNIQUE INDEX "scheduleSessions_sessionNumber_key" ON "scheduleSessions"("sessionNumber");
...
-- AddForeignKey
ALTER TABLE "subjects" ADD CONSTRAINT "subjects_idAcademicPeriod_fkey" FOREIGN KEY ("idAcademicPeriod") REFERENCES "academicPeriods"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "rooms" ADD CONSTRAINT "rooms_idSubjectType_fkey" FOREIGN KEY ("idSubjectType") REFERENCES "subjectTypes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
